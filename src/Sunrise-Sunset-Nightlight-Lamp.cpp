...
{
  red_day = param.asInt(); // getting first value
}

BLYNK_WRITE(V2) // Widget WRITEs to Virtual Pin
{
  green_day = param.asInt(); // getting N value
}

BLYNK_WRITE(V3) // Widget WRITEs to Virtual Pin
{
  blue_day = param.asInt(); // getting second value
}
